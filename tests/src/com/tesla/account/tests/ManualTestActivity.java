...
package com.tesla.setupwizard.tests;
...
public class ManualTestActivity extends Activity {
    ...
    private void enableSetup() {
        ...
        ComponentName componentName = new ComponentName("com.tesla.setupwizard",
                "com.tesla.setupwizard.ui.SetupWizardActivity");
        pm.setComponentEnabledSetting(componentName, PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                PackageManager.DONT_KILL_APP);
        componentName = new ComponentName("com.tesla.setupwizard",
                "com.tesla.setupwizard.setup.FinishSetupReceiver");
        pm.setComponentEnabledSetting(componentName, PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                PackageManager.DONT_KILL_APP);
        pm.clearApplicationUserData("com.tesla.setupwizard", null);
        ActivityManager am = (ActivityManager) getSystemService(Activity.ACTIVITY_SERVICE);
        am.killBackgroundProcesses("com.tesla.setupwizard");
        try {
